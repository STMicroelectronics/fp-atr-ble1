...
#define BLE_MANAGER_MAX_ALLOCABLE_CHARS 6U

/* Define the Max Dimension for Binary Content Feature */
#define DEFAULT_MAX_BINARY_CONTENT_CHAR_LEN     244
...
#define BLE_MANAGER_PRINTF  ATRBLE1_PRINTF
