/**
  ...
  * @version V2.1.0
  * @date    25-July-2023
  * @brief   Common Types used for Smart NFC protocol
  ******************************************************************************
  * @attention
  *
...
typedef struct
{
  ...
  uint8_t RFU;               /* Place holder for remembering that we have 1 byte RFU */
...
typedef struct
{
  ...
  SNFC_VirtualSensorEnum_t SensorType; /* Sensor/Thresholds type */
